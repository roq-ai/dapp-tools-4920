...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['developer', 'organization-owner', 'project-manager', 'end-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Developers', path: '/developers', entity: 'developer', service: AccessServiceEnum.PROJECT, icon: FiCode },
    {
