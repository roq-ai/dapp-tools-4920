...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project_create.create': {
    roles: ['organization-owner', 'project-manager', 'developer'],
    key: 'project_id',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['developer'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['organization-owner', 'project-manager', 'developer', 'end-user'];
