  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience dApp Tools - Your Premier Platform for Building dApp Tools on Networks Supporting ERC-20. Unleash the Power of Decentralization Today!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1676907820365-0ad1a99dbaa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkQXBwfGVufDB8fHx8MTY5NjgyNzk1OHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@shubzweb3?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Shubham's Web3`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience dApp Tools - Your Premier Platform for Building dApp Tools on Networks Supporting ERC-20. Unleash the Power of Decentralization Today!`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Developer" type="developer" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
